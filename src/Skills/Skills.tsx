...
export const Skills = () => {
    const [text, setText] = useState([
        ...
        {id: 2, skill: "CSS", aboute: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Omnis, quis."},
        {
            id: 3,
            skill: "React",
            aboute: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. At beatae consectetur cupiditate deserunt earum, expedita fuga iste magnam nam, necessitatibus nemo neque nisi, optio provident sed tempore vel veritatis vitae?"
        },
    ])
